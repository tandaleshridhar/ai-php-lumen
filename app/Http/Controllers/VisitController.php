...
class VisitController extends Controller 
{
  ...
  public function getVisitByCustomer(Request $request)
  {
    // select * from visits where columnName = columnValue
    $visit = Visit::where($request->columnName,'=', $request->columnValue)->get();
    return response()->json($visit, 200);
  }
}